            ...
            <div>
                <section className="pt-10">
                    <section className="w-full  ml-[5rem] mb-[5rem]">
                        <h1 className=" flex justify-center font-bold text-[3rem] pl-[2rem] mx-auto pt-5 text-white font-Manrope">WE ARE VAYUDOOT</h1>
                        <p className=" flex justify-centerfont-semibold pr-[15rem] pt-[2.5rem] pl-[2rem] leading-8">Our mission is to inspire and equip the next generation of engineers and innovators to push the boundaries of drone technology. Through hands-on competition, collaboration, and real-world problem-solving, we aim to foster creativity, technical excellence, and a spirit of innovation.</p>
                        
                    </section>
                    <section>
                        <div className="min-h-screen items-center justify-center text-white p-8">
                        ...
                        <div className="min-h-screen text-white ">
                            <div className="max-w-7xl mx-auto">
                                <div className=" items-center gap-2 mb-12">
                                    <h1 className="text-4xl text-center md:text-5xl font-bold tracking-wider mb-5">WE BELIEVE IN POWER OF COMPETITION</h1>
